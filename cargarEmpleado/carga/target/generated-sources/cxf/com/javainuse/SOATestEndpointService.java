 ...
 * 2021-01-14T12:56:31.541-05:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "SOATestEndpointService",
                  wsdlLocation = "file:/D:/cosos/entrevista/cargarEmpleado/carga/src/main/resources/wsdl/test.wsdl",
...
public class SOATestEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/cosos/entrevista/cargarEmpleado/carga/src/main/resources/wsdl/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOATestEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/cosos/entrevista/cargarEmpleado/carga/src/main/resources/wsdl/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
